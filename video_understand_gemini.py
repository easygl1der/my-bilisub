...
使用示例:
    ...
    # 指定模型
    python video_understand_gemini.py -video "video.mp4" --model gemini-2.5-flash
...
4. 使用详细模式:
   python video_understand_gemini.py -video "video.mp4" -m detailed
...
6. 保留上传的文件:
   python video_understand_gemini.py -video "video.mp4" --keep
    ...
    parser.add_argument('-m', '--mode', choices=['summary', 'brief', 'detailed', 'transcript'],
